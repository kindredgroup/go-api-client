  ...
  module Atom
    class FeedTest < Test::Unit::TestCase
      ...
      test "should stop at last seen atom entry id" do
        feed = GoApiClient::Atom::Feed.new('https://go-server.example.com/go/api/pipelines/tlb/stages.xml', 'https://go-server.example.com/go/pipelines/tlb/175/ant_count_tlb/1')
        feed.fetch!
      ...
      test "should stop at first page if entry id not specified" do
        ...
        feed = GoApiClient::Atom::Feed.new('https://go-server.example.com/go/api/pipelines/tlb/stages.xml')
        feed.fetch!
